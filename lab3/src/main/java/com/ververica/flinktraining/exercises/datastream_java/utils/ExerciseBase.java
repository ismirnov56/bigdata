...
public class ExerciseBase {
	...
	public final static String pathToRideData = "C:/big_data_labs_2020/data/nycTaxiRides.gz";
	public final static String pathToFareData = "C:/big_data_labs_2020/data/nycTaxiFares.gz";
